...
function new1(name,ImageFilePath,ImageFilePath1,BirthdayPage,y){
  ...
  function openBox(){
    ...
    if(step===4){
        reveal(name,ImageFilePath,ImageFilePath1,BirthdayPage,y);
       return;
    }     
...
function reveal(name,ImageFilePath,ImageFilePath1,BirthdayPage,y) {
